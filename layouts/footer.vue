  ...
  <div v-if="footer == null ? true : false" id="footer">
    <footer class="text-gray-600 body-font border-gray-100 border-solid border-t-2">
      <wrapper>
        <div class="px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            ...
            <p class="mt-2 text-sm text-gray-500">
              Warung online jual beli sayuran segar, cepat dan terjangkau
            </p>
          </div>
        ...
        <div class="bg-green-100 rounded-t-xl">
          <div class="mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p class="text-gray-500 text-sm text-center sm:text-left">
              &copy; {{ year }}. urBarn —
              <!-- <Tooltip text="Padjadjaran Master Developer">
                <a href="https://fauziru.github.io" rel="noopener noreferrer" class="text-white-600 ml-1 hover:text-green-500">
                  @fauziru
                </a>
              </Tooltip> -->
              <t-dropdown
