      ...
      <wrapper>
        <div class="px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            <Brand class="md:justify-start justify-center" />
            <p class="mt-2 text-sm text-gray-500">Warung online jual beli sayuran segar, cepat dan terjangkau</p>
          </div>
        ...
        <div class="bg-gray-100 rounded-t-xl">
          <div class="mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p class="text-gray-500 text-sm text-center sm:text-left">&copy; {{ year }}. urBarn —
              <a href="https://fauziru.github.io" rel="noopener noreferrer" class="text-gray-600 ml-1 hover:text-green-500" >@fauziru</a>
            </p>
